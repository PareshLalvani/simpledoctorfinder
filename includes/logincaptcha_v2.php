...
<?php
	...
	{
		echo '<tr>';
		echo '<td colspan="2" align="center" valign="top"><?php echo $msg;?></td>';
		echo '</tr>';
		echo '<?php } ?>';
		echo '<tr>';
		echo '<td align="right" valign="top"> Validation code:</td>';
		echo '<td>';
		echo '<img src="captcha.php?rand=<?php echo rand();?>" id="captchaimg">'.'<br>';
		echo '<label for="message">Enter the code above here :</label>'.'<br>';
		echo '<input id="includes/captcha_code" name="captcha_code" type="text">'.'<br>';
		echo "Can't read the image? click <a href='javascript: refreshCaptcha();'>here</a> to refresh.";
		echo '</td>';
		echo '</tr>';
		echo '<tr>';
		echo '<td>&nbsp;</td>';
		echo '<td><input name="Submit" type="submit" onclick="return validate();" value="Submit" class="button1"></td>';
		echo '</tr>';
		echo '</table>';
		echo '</form>';
	}
